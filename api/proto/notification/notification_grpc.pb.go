...
const (
	Notification_Notify_FullMethodName = "/switch.v1.Notification/Notify"
)
...
func (c *notificationClient) Notify(ctx context.Context, in *NotificationRequest, opts ...grpc.CallOption) (*NotificationResponse, error) {
...
func (UnimplementedNotificationServer) Notify(context.Context, *NotificationRequest) (*NotificationResponse, error) {
...
func _Notification_Notify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServer).Notify(ctx, req.(*NotificationRequest))
	}
...
var Notification_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "switch.v1.Notification",
